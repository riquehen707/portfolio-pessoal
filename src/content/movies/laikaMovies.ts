...
export const laikaMovieSeeds: MovieSeed[] = [
  {
    ...
    countries: ["Estados Unidos"], directors: ["Henry Selick"], screenwriters: ["Henry Selick"], studioIds: ["stu_laika"],
  ...
  },
  {
    ...
    countries: ["Estados Unidos"], directors: ["Sam Fell", "Chris Butler"], screenwriters: ["Chris Butler"], studioIds: ["stu_laika"],
  ...
  },
  {
    ...
    countries: ["Estados Unidos"], directors: ["Graham Annable", "Anthony Stacchi"], screenwriters: ["Irena Brignull", "Adam Pava"], studioIds: ["stu_laika"],
  ...
  },
  {
    ...
    countries: ["Estados Unidos"], directors: ["Travis Knight"], screenwriters: ["Marc Haimes", "Chris Butler"], studioIds: ["stu_laika"],
  ...
  },
  {
    ...
    countries: ["Estados Unidos"], directors: ["Chris Butler"], screenwriters: ["Chris Butler"], studioIds: ["stu_laika"],
  ...
  },
  {
    ...
    countries: ["Estados Unidos"], directors: ["Travis Knight"], screenwriters: ["Chris Butler"], studioIds: ["stu_laika"],
