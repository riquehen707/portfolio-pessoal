...
const GameSchema = z.object({
  id:z.string().regex(/^game_[a-z0-9_]+$/), slug:z.string(), aliases:z.array(z.string()), title:z.string(), year:z.number(), status:z.literal("released"),
