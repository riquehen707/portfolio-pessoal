    ...
    skills: [
      {
        ...
        tags: [
          { name: "Páginas rápidas", icon: "nextjs" },
          { name: "Interface modular", icon: "javascript" },
          { name: "Deploy estável", icon: "vercel" },
        ],
        images: [],
      },
      {
        ...
        tags: [
          { name: "Fluxos internos", icon: "vue" },
          { name: "Interação clara", icon: "javascript" },
          { name: "Componentes reutilizáveis", icon: "grid" },
        ],
        images: [],
      },
      {
        ...
        tags: [
          { name: "Visual consistente", icon: "sass" },
          { name: "Mobile bem resolvido", icon: "grid" },
          { name: "Sistema reaproveitável", icon: "grid" },
        ],
        images: [],
      },
      {
        ...
        tags: [
          { name: "Busca preparada", icon: "seo" },
          { name: "Catálogo encontrável", icon: "shopify" },
          { name: "Conteúdo organizado", icon: "book" },
        ],
        images: [],
      },
      {
        ...
        tags: [
          { name: "Rotinas sob medida", icon: "python" },
          { name: "Dados acionáveis", icon: "chart" },
          { name: "Menos trabalho manual", icon: "rocket" },
        ],
        images: [],
      },
    ],
